...
export function useMyDockPositions(address: any, gameID: number) {
    const { components } = useMUD();

    const dockEntity = useEntityQuery([HasValue(components.DockOwnable, { owner: address, gameID: BigInt(gameID) })]);

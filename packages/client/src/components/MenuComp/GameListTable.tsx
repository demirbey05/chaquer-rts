...
export const GameListTable = ({ selectedPlayers, gameNameFilter, setIsJoinGameModalOpen, setIsSpectateGameModalOpen, username }:
    ...
    return (
        <TableContainer textColor={"white"} overflowY="scroll" backgroundColor={"rgba(0,0,0,0.8)"} height={"475px"}>

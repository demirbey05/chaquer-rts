...
library CastleOwnable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "CastleOwnable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000436173746c654f776e61626c65000000);

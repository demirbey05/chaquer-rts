...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CreditOwn")));
bytes32 constant CreditOwnTableId = _tableId;
...
library CreditOwn {
  ...
  function encode(uint256 amount) internal pure returns (bytes memory) {

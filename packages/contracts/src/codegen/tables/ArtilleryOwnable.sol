...
library ArtilleryOwnable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ArtilleryOwnable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000417274696c6c6572794f776e61626c65);

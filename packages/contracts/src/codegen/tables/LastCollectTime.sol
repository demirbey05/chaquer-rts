...
library LastCollectTime {
  ...
  function set(address owner, uint256 gameID, uint256 lastCollect) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((lastCollect)), getFieldLayout());
  }
  ...
  function set(IStore _store, address owner, uint256 gameID, uint256 lastCollect) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((lastCollect)), getFieldLayout());
  }

  /** Tightly pack full data using this table's field layout */
  function encode(uint256 lastCollect) internal pure returns (bytes memory) {

...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("ArmyConfig")))
);
ResourceId constant ArmyConfigTableId = _tableId;
...
library ArmyConfig {
  ...
  /**
   * @notice Get numSwordsman (using the specified store).
   */
  ...
  /**
   * @notice Set numSwordsman (using the specified store).
   */
  function setNumSwordsman(IStore _store, bytes32 key, uint32 numSwordsman) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((numSwordsman)), _fieldLayout);
  }
  ...
  /**
   * @notice Get numArcher (using the specified store).
   */
  ...
  /**
   * @notice Set numArcher (using the specified store).
   */
  function setNumArcher(IStore _store, bytes32 key, uint32 numArcher) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((numArcher)), _fieldLayout);
  }
  ...
  /**
   * @notice Get numCavalry (using the specified store).
   */
  ...
  /**
   * @notice Set numCavalry (using the specified store).
   */
  function setNumCavalry(IStore _store, bytes32 key, uint32 numCavalry) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((numCavalry)), _fieldLayout);
  }
  ...
  function decodeStatic(
    ...
    numSwordsman = (uint32(Bytes.slice4(_blob, 0)));

    numArcher = (uint32(Bytes.slice4(_blob, 4)));

    numCavalry = (uint32(Bytes.slice4(_blob, 8)));

...
library ArmyPrices {
  ...
  function setPriceSwordsman(uint256 gameID, uint256 priceSwordsman) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((priceSwordsman)), getValueSchema());
  }
  ...
  function setPriceSwordsman(IStore _store, uint256 gameID, uint256 priceSwordsman) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((priceSwordsman)), getValueSchema());
  }
  ...
  function setPriceArcher(uint256 gameID, uint256 priceArcher) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((priceArcher)), getValueSchema());
  }
  ...
  function setPriceArcher(IStore _store, uint256 gameID, uint256 priceArcher) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((priceArcher)), getValueSchema());
  }
  ...
  function setPriceCavalry(uint256 gameID, uint256 priceCavalry) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 2, abi.encodePacked((priceCavalry)), getValueSchema());
  }
  ...
  function setPriceCavalry(IStore _store, uint256 gameID, uint256 priceCavalry) internal {
    ...
    _store.setField(_tableId, _keyTuple, 2, abi.encodePacked((priceCavalry)), getValueSchema());
  }

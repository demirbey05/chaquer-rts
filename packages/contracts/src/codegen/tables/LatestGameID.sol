...
library LatestGameID {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "LatestGameID", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c617465737447616d65494400000000);

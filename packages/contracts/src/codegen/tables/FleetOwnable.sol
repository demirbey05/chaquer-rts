...
library FleetOwnable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "FleetOwnable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000466c6565744f776e61626c6500000000);

...
library NumberOfUsers {
  ...
  function set(uint256 gameId, uint256 numOfUsers) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((numOfUsers)), getFieldLayout());
  }
  ...
  function set(IStore _store, uint256 gameId, uint256 numOfUsers) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((numOfUsers)), getFieldLayout());
  }

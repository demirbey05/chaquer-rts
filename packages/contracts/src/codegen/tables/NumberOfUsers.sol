...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("NumberOfUsers")));
bytes32 constant NumberOfUsersTableId = _tableId;
...
library NumberOfUsers {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "numOfUsers";
    return ("NumberOfUsers", _fieldNames);
  }
  ...
  function set(uint256 gameId, uint256 numOfUsers) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((numOfUsers)));
  }
  ...
  function set(IStore _store, uint256 gameId, uint256 numOfUsers) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((numOfUsers)));
  }

  /** Tightly pack full data using this table's schema */
  function encode(uint256 numOfUsers) internal view returns (bytes memory) {

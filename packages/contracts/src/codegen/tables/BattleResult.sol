...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BattleResult")));
bytes32 constant BattleResultTableId = _tableId;
...
library BattleResult {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("BattleResult", _fieldNames);
  }
  ...
  function emitEphemeral(bytes32 key, BattleResultData memory _table) internal {
  ...
  function emitEphemeral(IStore _store, bytes32 key, BattleResultData memory _table) internal {

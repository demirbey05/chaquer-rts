...
library Players {
  ...
  function set(uint256 gameId, address userAddress, bool userValid) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((userValid)), getValueSchema());
  }
  ...
  function set(IStore _store, uint256 gameId, address userAddress, bool userValid) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((userValid)), getValueSchema());
  }

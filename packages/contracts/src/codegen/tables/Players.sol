...
library Players {
  ...
  function set(uint256 gameId, address userAddress, bool userValid) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((userValid)), getFieldLayout());
  }
  ...
  function set(IStore _store, uint256 gameId, address userAddress, bool userValid) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((userValid)), getFieldLayout());
  }

  /** Tightly pack full data using this table's field layout */
  function encode(bool userValid) internal pure returns (bytes memory) {
